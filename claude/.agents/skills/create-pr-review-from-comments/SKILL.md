...
You may add extra context to a comment if needed to better explain it, but if you do this you MUST do it in a separate paragraph that starts
with "AI says: " so that it's very clear what the original reviewer wrote and what you are adding.
